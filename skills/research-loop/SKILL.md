---
name: research-loop
description: Run the canonical orchestrator-led AI Scientist research loop with worker-owned nodes, explicit resource leases, mode-specific prompts, and Stop-hook continuation.
---
...
<Startup>
When initially starting research-loop, without continuing from a previous loop, read and folow the instructions given before starting. DO NOT PROCEED WITHOUT COMPLETING NEEDED STEPS.
