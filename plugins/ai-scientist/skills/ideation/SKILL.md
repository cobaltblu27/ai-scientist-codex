...
7. Finalized ideas are written to `.ai-scientist/ideas/ideas.json` using the existing idea schema. Ideas that do not finalize within the reflection budget are skipped and logged.
